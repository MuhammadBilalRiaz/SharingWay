...
class FriendRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friend_request" do
    assert_difference('FriendRequest.count') do
      post friend_requests_url, params: { friend_request: { receiver_id: @friend_request.receiver_id, sender_id: @friend_request.sender_id, status_id: @friend_request.status_id } }
    end
  ...
  test "should update friend_request" do
    patch friend_request_url(@friend_request), params: { friend_request: { receiver_id: @friend_request.receiver_id, sender_id: @friend_request.sender_id, status_id: @friend_request.status_id } }
